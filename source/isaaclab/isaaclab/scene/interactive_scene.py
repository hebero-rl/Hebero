...
class InteractiveScene:
    ...
    * For tasks that require having separate assets in the environments, ``replicate_physics`` would have to
    ...
    def reset(self, env_ids: Sequence[int] | None = None):
        ...
        # Normalise the reset ids once, not once per entity: the conversion does
        # not depend on which entity is being filtered, and this runs for every
        # articulation, rigid object, sensor and collection in the scene.
