...
class _DynCfg:
    ...
    def __init__(self, **kwargs):
        """Store each keyword argument as an instance attribute."""
        for k, v in kwargs.items():
            setattr(self, k, v)

    def __repr__(self) -> str:
        """Return a debug string listing all stored attributes."""
...
class MultiTaskRegistry:
    ...
    def __init__(self) -> None:
        """Initialize the registry with an empty list of registrations."""
    ...
    def _build_events(self) -> _DynCfg:
        """Merge per-robot and per-task reset event terms across registrations."""
